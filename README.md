...
UniCoracle was developed for microbial community feature selection associated with continous variables (e.g, thermal tolerance, seawater temperature, seawater salinity), with particular application to coral-associated microbiome datasets. Exploits taxonomic structure of microbiome data. 
